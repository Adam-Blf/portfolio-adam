...
export const experiences = [
  {
    ...
    missions: [
      "Architecture de donnees: Modelisation base Oracle, optimisation et performance",
      "Developpement Backend: API PHP pour interoperabilite et acces securise",
      "Pipelines de donnees: ETL/ELT (SQL/PL-SQL), Docker et CI/CD",
      "Data Science: Modeles predictifs ML pour admissions, monitoring qualite RGPD",
      "Reporting: Tableaux de bord BI (Business Objects, PMSI-Pilot)",
    ],
    tech: ["PHP", "Oracle", "SQL/PL-SQL", "Python", "Docker", "Git", "Business Objects"],
  },
  {
    id: 2,
    ...
    endDate: "2025-09",
    current: false,
    description: "Refonte ecosysteme digital du GHT Psy NPdC (sante mentale)",
    missions: [
      "Analyse fonctionnelle et specifications techniques des projets digitaux",
      "Creation KPI et tableaux de bord pour suivi des performances",
      "Methodologie projet: documentation, suivi regulier, iterations",
    ],
    tech: ["Strategie Digitale", "Data Visualization", "Python", "Streamlit"],
  },
  {
    id: 3,
    ...
    endDate: "2024-07",
    current: false,
    description: "Communication visuelle et digitale pour agence",
    missions: [
      "Creation contenu engageant et storytelling",
      "Strategie communication digitale et visuels impactants",
      "Gestion ecosysteme communication avec approche creative",
    ],
    tech: ["Design", "Social Media", "Storytelling"],
  },
  {
    id: 4,
    ...
    missions: [
      "Animation ceremonies Scrum: Daily, Sprint Planning, Review, Retros",
      "Gestion Product Backlog: User Stories, priorisation",
      "Suivi KPIs: Velocity, Burndown Chart, taux completion",
      "Identification et escalade des blocages",
    ],
  ...
  },
  {
    ...
    endDate: "2022-07",
    current: false,
    description: "Premier stage en communication digitale",
    missions: [
      "Gestion reseaux sociaux",
      "Creation de contenu visuel",
      "Relation client et suivi projets",
    ],
    tech: ["Social Media", "Design", "Marketing"],
  },
  {
    id: 6,
    ...
    location: "France",
    type: "Job etudiant",
    period: "Nov 2021 - Aout 2022",
    startDate: "2021-11",
    endDate: "2022-08",
    current: false,
    description: "Experience en restauration rapide",
    missions: [
      "Service client et prise de commandes",
      "Preparation des produits",
      "Travail en equipe sous pression",
    ],
  ...
  },
  {
    ...
    endDate: "2021-12",
    current: false,
    description: "Jobs etudiants en entretien",
    missions: [
      "Entretien des locaux",
      "Autonomie et rigueur",
    ],
    tech: ["Autonomie", "Rigueur"],
  },
  {
    id: 8,
    ...
    endDate: "2021-07",
    current: false,
    description: "Formation militaire sur 10 mois - Mention Assez Bien",
    missions: [
      "Apprentissage bases Marine Nationale, tir, lutte incendie",
      "Participation ceremonies militaires",
      "Permis bateau et PSC1",
    ],
    tech: ["Leadership", "Discipline", "Travail d'equipe"],
  },
]
